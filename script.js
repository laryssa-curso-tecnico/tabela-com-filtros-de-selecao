function atualizarTotais(contadorLinhas, somaSalarios) {
    ...
    document.getElementById("somaSalarios").textContent = somaSalarios.toLocaleString('pt-BR', {
        style: 'currency',
        currency: 'BRL'
    });
}
...
function exportarParaExcel() {
    ...
    var workbook = XLSX.utils.table_to_book(tabelaClone, { sheet: "Funcionarios" });
